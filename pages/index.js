    ...
    return (
        <>
            ...
            >
                ...
                <h2 className="uppercase tracking-wide font-bold text-center mt-2 text-3xl xs:text-4xl sm:text-5xl md:text-7xl lg:text-8xl">
                    Federico Gentili
                </h2>
                <h3 className="uppercase tracking-widest font-bold text-center mt-1 mb-1 text-xl xs:text-2xl md:text-4xl lg:text-5xl text-foreground/75">
                    {h3}
                </h3>
                <p
